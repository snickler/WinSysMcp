...
- GitHub Actions CI runs matching test and Native AOT publish matrices in parallel (`win-arm64` on `windows-11-arm`, `win-x64` on the standard Windows runner); tagged releases wait for both matrices before publishing artifacts.
